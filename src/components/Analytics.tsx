...
function BrandDetailView({ winners, brand, colorHex, borderColor, adTotals, timeFilter }: { 
  ...
  // Only include video winners for duration analysis (static variants don't have duration)
  ...
  // Music groups (video only - static variants don't have music)
  ...
  // Only include video winners for mention timing (static variants don't have mentions)
            ...
            {winRateData.monthlyData.length > 0 ? (
              <div className="space-y-3">
                ...
                {(() => {
                  ...
                  return winRateData.monthlyData.map(({ month, winners: w, variants, winRate }) => {
...
function ComparisonView({ kikoffWinners, grantWinners, allWinners, adTotals }: { kikoffWinners: Winner[]; grantWinners: Winner[]; allWinners: Winner[]; adTotals: MonthlyAdTotals[] }) {
  ...
  // Duration analysis (video only - static variants don't have duration)
  ...
  // Mention timing analysis (video only - static variants don't have mentions)
  ...
  // Music counting (video only - static variants don't have music)
          ...
          <div className="grid grid-cols-3 divide-x divide-slate-200 dark:divide-slate-700">
            ...
            <div className="p-5 text-center">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                <span className="font-medium text-slate-600 dark:text-slate-300">{winRates.kikoffWins}</span> wins / <span className="font-medium text-slate-600 dark:text-slate-300">{winRates.kikoffAds}</span> variants
              </p>
            </div>
            ...
            <div className="p-5 text-center bg-gradient-to-b from-indigo-50/50 to-transparent dark:from-indigo-900/20 dark:to-transparent">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                <span className="font-medium text-slate-600 dark:text-slate-300">{winRates.kikoffWins + winRates.grantWins}</span> wins / <span className="font-medium text-slate-600 dark:text-slate-300">{winRates.kikoffAds + winRates.grantAds}</span> variants
              </p>
            </div>
            ...
            <div className="p-5 text-center">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                <span className="font-medium text-slate-600 dark:text-slate-300">{winRates.grantWins}</span> wins / <span className="font-medium text-slate-600 dark:text-slate-300">{winRates.grantAds}</span> variants
              </p>
            </div>
          </div>
        </div>
